...
6. Portfolio news (single), crimson, bleed:true: top ~57%: a layer with the photo (tone house, ratio 16:9) and the lockup logo (tone dark, size s) anchored top left with inset l. Below, a stack (padding xl, gap m): a row with the gold eyebrow "PORTFOLIO NEWS" on the left and the company logo on a light chip (stack fill light, padding s) on the right; a headline (white) with the company name highlighted; a growing empty stack to push the footer down; a divider; a row with the lockup logo (tone dark, s) and micro "YALI.VC" aligned right.
