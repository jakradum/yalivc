  ...
  return (
    <svg width="564" height="762" viewBox="0 0 564 762" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url(#clip0_209_25726)">
        ...
        <circle cx="22.214" cy="511.357" r="3.6691" fill="#C4C4C4" />
        <circle cx="286.388" cy="512.579" r="3.6691" fill="#C4C4C4" />
        <circle cx="527.669" cy="282.669" r="3.6691" fill="#C4C4C4" />
        <circle cx="455.165" cy="119.986" r="3.6691" fill="#C4C4C4" />
        <circle cx="135.954" cy="226.39" r="3.6691" fill="#C4C4C4" />
        <circle cx="382.669" cy="576.669" r="3.6691" fill="#C4C4C4" />
        <circle cx="462.669" cy="577.669" r="3.6691" fill="#C4C4C4" />
        <circle cx="532.218" cy="649.56" r="3.6691" fill="#C4C4C4" />
        <circle cx="532.082" cy="382.361" r="4.08214" fill="#C4C4C4" />
      </g>
      <rect x="0.5" y="0.5" width="563" height="761" stroke="black" />
      <defs>
        <clipPath id="clip0_209_25726">
          <rect width="564" height="762" fill="white" />
        </clipPath>
        <clipPath id="clip1_209_25726">
          <rect width="513.599" height="657.991" fill="white" transform="translate(20.875 57)" />
        </clipPath>
      </defs>
    </svg>
  );
